...
export class NotesComponent implements OnInit, OnDestroy {
  ...
  constructor(private vampireDASheetStoreService: VampireDarkAgesSheetStoreService) {}

  ngOnInit(): void {
    this.editor = new Editor();
    this.sheetSubscription = this.vampireDASheetStoreService
      .selectVampireDASheet()
      .subscribe((sheet: VampireDarkAgesSheet) => {
